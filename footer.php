...
else if ($footer_style == 'viewforum' || $footer_style == 'viewtopic')
{
	...
	if ($pun_config['o_quickjump'] == '1')
	{
		...
		@include CACHE_DIR.'/cache_quickjump_'.$pun_user['g_id'].'.php';
...
?>
			<p class="conr">Powered by <a href="http://www.phunkybb.docunext.com/blog/">PhunkyBB</a>, a fork of punbb <?php if ($pun_config['o_show_version'] == '1') echo ' '.$pun_config['o_cur_version']; ?><br />&copy; Copyright 2002&#8211;2005 Rickard Andersson</p>
<?php
...
<?php
if(isset($pun_config['o_google_analytics_code'])) {
?>
<script src="http://www.google-analytics.com/urchin.js" type="text/javascript">

</script>
<script type="text/javascript">
_uacct = "<?php echo $pun_config['o_google_analytics_code']; ?>";
urchinTracker();
</script>
<?php
}
