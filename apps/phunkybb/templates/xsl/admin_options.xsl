                    ...
                    <div class="infldset">
                        <table class="aligntop" cellspacing="0">
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="form[board_title]" size="50" maxlength="255" value="{//board_config/o_board_title}" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="form[board_desc]" size="50" maxlength="255" value="{//board_config/o_board_desc}" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="form[base_url]" size="50" maxlength="100" value="{//board_config/o_base_url}" />
                    ...
                    <div class="infldset">
                        <table class="aligntop" cellspacing="0">
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="form[time_format]" size="25" maxlength="25" value="{//board_config/o_time_format}" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="form[date_format]" size="25" maxlength="25" value="{//board_config/o_date_format}" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="form[timeout_visit]" size="5" maxlength="5" value="{//board_config/o_timeout_visit}" />
